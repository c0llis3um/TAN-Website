            ...
            <Card hover={false} className="overflow-hidden">
              ...
              <div className="p-6 space-y-3">
                ...
                <motion.button whileHover={{ scale: 1.02, y: -1 }} whileTap={{ scale: 0.98 }}
                  ...
                  className="w-full flex items-center justify-center gap-3 py-4 rounded-2xl dark:bg-white bg-slate-900 dark:text-slate-900 text-white font-bold text-lg shadow-glow-sm hover:shadow-glow transition-all">
                  <AppleIcon /> Pay
                </motion.button>
...
function GooglePayIcon() {
  return (
    <span className="font-black text-base tracking-tighter">
      ...
      {' '}<span className="dark:text-slate-300 text-slate-700">Pay</span>
    </span>
  )
}
